    ...
    <div className="space-y-4 pb-20 md:pb-0">
      ...
      {isEditing && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
          ...
          <div className="relative w-full sm:max-w-sm bg-card rounded-t-3xl sm:rounded-2xl border shadow-xl p-5 sm:p-6 space-y-4 max-h-[90vh] overflow-y-auto">
