'use client'
/**
 * @file Page de connexion — Magic Link
 */
          ...
          {!sent ? (
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                >
                  {loading ? 'Envoi...' : 'Envoyer le lien magique ✉️'}
                </button>
              </form>
              ...
              <button className="w-full mt-4 py-2.5 border rounded-lg font-medium text-sm flex items-center justify-center gap-2 hover:bg-muted transition-colors">
            ...
            >
              ...
              <p className="text-muted-foreground text-sm">
                ...
                <br />Le lien expire dans 10 minutes.
              </p>
              <button
