    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-emerald-600">Quran Tracker</h1>
          <p className="text-muted-foreground mt-1">Suivi de mémorisation en groupe</p>
        </div>
            ...
            {step === 'email' && (
              ...
              >
                ...
                <form onSubmit={handleSendOtp} className="space-y-4">
                  ...
                  >
                    {loading ? 'Envoi...' : 'Recevoir mon code ✉️'}
                  </button>
                </form>
            ...
            {step === 'otp' && (
              ...
              >
                ...
                <form onSubmit={handleVerifyOtp} className="space-y-4">
                  <div>
                    <label className="text-sm font-medium block mb-1.5 text-center">Code à 6 chiffres</label>
                    <input
                      type="text"
                      inputMode="numeric"
                      value={otp}
                      ...
                      maxLength={6}
                      autoFocus
                      className="w-full px-3 py-4 rounded-lg border bg-background text-center text-3xl font-bold tracking-[0.5em] focus:outline-none focus:ring-2 focus:ring-emerald-500"
                    />
                  </div>
                  {error && (
                    <p className="text-sm text-red-500 bg-red-50 dark:bg-red-950 px-3 py-2 rounded-lg text-center">{error}</p>
                  )}
                  <button
                    type="submit"
